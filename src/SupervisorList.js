...
const SupervisorList = ({
  ...
  return (
    <Container className="employee-list">
      <h2 className="text-center mb-4">Supervisor List</h2>
        ...
        supervisors.map((supervisor) => {
          ...
          return (
            <Container
              ...
              className="employee-card bigbox"
              onClick={(event) => {
                console.log("Supervisor box clicked with ID:", supervisor.uid);
                onSupervisorBoxClick(supervisor.uid, event);
              }}
            >
                  ...
                  <Col xs={12} md={3}>
                    <Card
                      ...
                      style={{
                        cursor: "pointer",
                        backgroundColor:
                          activeFilter === "Work in Progress" ? "#e9ecef" : "",
                      }}
                      onClick={() => {
