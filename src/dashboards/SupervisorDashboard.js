      ...
      try {
        ...
        if (supervisorsDocSnapshot.exists()) {
          ...
          if (supervisorsData.tasks && supervisorsData.tasks.length > 0) {
            ...
            const extractedProjectNames = supervisorsData.tasks.map(
              (task) => task.project
            );
          ...
          if (supervisorsData.tasks && supervisorsData.tasks.length > 0) {
            ...
            const extractedTaskNames = supervisorsData.tasks.map(
              (task) => task.task
            );
            // Remove duplicates using Set
          ...
          if (supervisorsData.tasks && supervisorsData.tasks.length > 0) {
            ...
            const extractedSubtaskNames = supervisorsData.tasks.map(
              (task) => task.subtask
            );
            // Remove duplicates using Set
